...
/**
 *  Takes processes input from RoboThink and directs it to other 
...
public class RoboOutput {
    ...
    public void initialize( int left, int right ){
        ...
        this.airCompressor=new Compressor( FRCConfig.SLOT_PRESSURE, + 
                FRCConfig.SLOT_COMPRESSOR_RELAY );
    ...
    /**
     * Sets drive motors and grabber motors power level
     * Sets the solenoid state to off or on
     * Turns the shooter pin off or on
     */
