...
public class InputData {
    ...
    /**
     * The coordinates for the left driver stick where index 0 is X, index 1 is
     * Y, index 2 is Z
     */
    public static double leftDriverStick[] = {0, 0, 0};

    /**
     * The coordinates for the right driver stick where index 0 is X, index 1 is
     * Y, index 2 is Z
     */
    public static double rightDriverStick[] = {0, 0, 0};

    /**
     * The coordinates for the co-driver stick where index 0 is X, index 1 is Y,
     * index 2 is Z
     */
